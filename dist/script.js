...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Castomizator; });
...
/*#__PURE__*/
function () {
  function Castomizator() {
    var _this = this;

    _classCallCheck(this, Castomizator);
  ...
  _createClass(Castomizator, [{
    ...
    value: function onColorChange(e) {
      ...
      localStorage.setItem('color', "".concat(e.target.value));
    }
  }, {
    key: "onScaleChange",
